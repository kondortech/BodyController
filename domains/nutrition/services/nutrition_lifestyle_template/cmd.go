...
import (
	...
	"github.com/kirvader/BodyController/domains/nutrition/services/base/nutrition_lifestyle_template/src"
...
func main() {
	...
	svc, close, err := src.NewNutritionLifestyleTemplateService(ctx)
	if err != nil {
		panic(err)
	}
	defer close()
