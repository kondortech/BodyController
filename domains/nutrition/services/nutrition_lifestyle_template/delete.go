...
func (svc *NutritionLifestyleTemplateService) Delete(ctx context.Context, req *DeleteNutritionLifestyleTemplateRequest) (*DeleteNutritionLifestyleTemplateResponse, error) {
